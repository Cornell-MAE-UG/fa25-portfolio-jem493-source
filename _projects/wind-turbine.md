...
* **Optimization:** We utilized a Weibull probability distribution to identify the optimal design wind speed of 5.3 m/s, ensuring we targeted the highest energy density area of the wind curve to maximum the efficiency and power generation of our turbine blade.
...
<img src="/assets/power-curve.jpg" width="600">
*Experimental power curves showing peak performance at various RPMs. This data was collected using a LabView VI prebuilt in the Big Blue wind tunnel*
