...
* **Fabrication:** The blades were modeled in Fusion 360 to ensure compatibility with the 3D printing process and the hub connector constraints (hub was provided by course to maintain compatability with the torque brake). The 3D printing was outsourced (for all groups) with the assistance of course staff.
...
## My Contribution
In this group project, I focused primarily on developing the MATLAB code to calculate the Weibull distribution and optimal twist/taper ratios, and other blade characteristics. We had group members who have taken the MAE wind power class, which proved very helpful in refining and applying concepts introduced during this class.
